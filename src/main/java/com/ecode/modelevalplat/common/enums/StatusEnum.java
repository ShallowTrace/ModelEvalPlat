...
public enum StatusEnum {
    ...
    // 比赛报名模块 (700前缀)
    COMPETITION_REGISTRATION_SUCCESS(700_200_001, "比赛报名成功"),
    COMPETITION_NOT_FOUND(700_404_002, "比赛不存在"),
    COMPETITION_INACTIVE(700_400_001, "比赛未激活"),
    COMPETITION_NOT_STARTED(700_400_002, "比赛尚未开始"),
    COMPETITION_ENDED(700_400_003, "比赛已结束"),
    ALREADY_REGISTERED(700_409_001, "用户已报名该比赛"),
    REGISTRATION_SYSTEM_ERROR(700_500_002, "报名系统异常");
